...
class MiniSearchBar extends Component {
    ...
    handleSubmit = () => {
        ...
        // this function handles the sending of the get request (based on search inputs)
    ...
    render() {
        return (
              ...
              <form method="get">
                <div style = {{display: 'inline-block'}}>
                    <div className="mini-search-bar-container">
                        <div className="tb">
                          <div className="td">
                            <input type="text" placeholder="Search for a name, muscle group or location..." className = "mini-search-input" id = "search-input" onChange = {(value)=> this.setState({search_term: value})}/>
                          </div>
                          <div className = "mini-button-cover">
                              <div className="td" id="s-cover">
                                <Link to = "/pt_results" >
                                <button style = {{transform: "scale(0.7)"}}  type="submit" className = "animated-button" onClick = {this.handleSubmit}>
                                  <div id="s-circle"></div>
                                  <span></span>
                                </button>
                                </Link >
            ...
            <MultiSelect
                ...
                style = {{display: 'inline-block', maxWidth: '170px', paddingRight: '1em'}}
                showCheckbox
            >
